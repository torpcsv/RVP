...
from .io import (normalize_user_shape, _valid_user_shape, load_user_patterns,
    ...
    USRPTN_EXT, dump_user_patterns, parse_user_patterns, replace_user_patterns,
    ...
    csv_val_of, csv_hold_pos, load_csv_points, dump_csv, write_csv,
    merge_csv_channels)  # noqa: F401
